class UserAuthenticationController < ApplicationController
  ...
  def create
    ...
    @user.profile_photo = params.fetch("query_profile_photo")
    @user.roles_id = params.fetch("query_roles_id")
    @user.issues_id = params.fetch("query_issues_id")
    @user.building_id = params.fetch("query_building_id")
    @user.roles_count = params.fetch("query_roles_count")
